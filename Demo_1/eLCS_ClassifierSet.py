...
from Demo_1.eLCS_Classifier import Classifier
...
class ClassifierSet:
    ...
    def runPopAveEval(self, exploreIter):
        ...
        for cl in self.popSet:
            genSum += (
            (cons.env.formatData.numAttributes - len(cl.condition)) / float(cons.env.formatData.numAttributes))
    ...
    def getPopTrack(self, exploreIter, trackingFrequency):
        ...
        if cons.env.formatData.discretePhenotype:  # discrete phenotype
            print(("Iteration: " + str(exploreIter) + "\t PopSize: " + str(len(self.popSet)) + "\t AveGen: " + str(
                self.aveGenerality)))
        else:  # continuous phenotype
            print(("Iteration: " + str(exploreIter) + "\t PopSize: " + str(len(self.popSet)) + "\t AveGen: " + str(
