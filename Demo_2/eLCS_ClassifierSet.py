...
from Demo_2.eLCS_Constants import cons
from Demo_2.eLCS_Classifier import Classifier
...
class ClassifierSet:
    ...
    def makeMatchSet(self, state_phenotype, exploreIter):
        ...
        print(
            "-----------------------------------------------------------------------------------------------------------------------------------")
        print("Current instance from dataset:  " + "State = " + str(state_phenotype[0]) + "  Phenotype = " + str(
            state_phenotype[1]))
        print("--------------------------------------------------------------------------------------")
        print("Match Set:")
        # ------------------------------------------
        ...
        for i in range(len(self.popSet)):  # Go through the population
            ...
            if cl.match(state):  # Check for match
                # DEMO 2 CODE-------------------------
                print("Condition: " + str(cl.reportClassifier()) + "  Phenotype: " + str(
                    cl.phenotype) + "  Fitness: " + str(cl.fitness))
                # ------------------------------------------
